        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="text-xl font-bold">TradeSense</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Professional prop trading platform designed for aspiring traders. 
              Practice with virtual funds, master the markets, and get funded.
            </p>
